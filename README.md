Contrained Minimum Energy Designs (CoMinED)
================
Chaofan (Bill) Huang
...
![](README_files/figure-gfm/mot-1.png)<!-- -->
...
In many real world applications, the constraints could yield values in
...
![](README_files/figure-gfm/mot-s-comined-1.png)<!-- -->
